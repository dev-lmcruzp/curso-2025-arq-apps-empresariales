...
namespace TSquad.Ecommerce.Service.WebApi.Controllers.v2
{
    /// <inheritdoc />
    ...
    public class CustomersController : ControllerBase
    {
        ...
        [SwaggerResponse(StatusCodes.Status200OK, "Clientes encontrado", typeof(ResponsePagination<IEnumerable<Customer>>))]
